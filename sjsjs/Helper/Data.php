...
class Magestore_Webpos_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getValueForOrder($order, $amount = 0)
    {
        ...
        if ($order && $amount) {
            ...
            $baseAmount = Mage::helper('webpos/currency')->currencyConvert($amount, $orderCurrencyCode, $baseOrderCurrencyCode);
        }
    ...
    public function getWebposConfig($session = false)
    {
        ...
        $config = array(
            ...
            'customerAttributes' => Mage::helper('webpos/config')->getCustomerAttributes(),
            'customerConfig' =>Mage::helper('webpos/config')->getCustomerConfig(),

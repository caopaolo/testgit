...
//        return $result;
    ...
    public function cancelOrder($order) {
        ...
        try {
            ...
            if($realAmount > 0) {
                $realAmount -= $order->getData('total_refunded');
                $baseRealAmount -= $order->getData('base_total_refunded');
                ...
                $transaction->setData(array(
                    ...
                    Magestore_Webpos_Api_TransactionInterface::ORDER_ID => $order->getId(),
                    ...
                    Magestore_Webpos_Api_TransactionInterface::TYPE => 'cancel',
